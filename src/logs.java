   ...
   public logs() {
    ...
    private void fetchLogs() {
        ...
        try (Connection con = ConnectionProvider.getCon()) {
            String sql = "SELECT r.recordID, r.studentID, r.bookID, b.bookTitle, u.fullname, r.borrowDate, r.returnDate " +
                         "FROM borrow_records r " +
                         "LEFT JOIN books b ON r.bookID = b.bookID " +
                         "LEFT JOIN user u ON r.studentID = u.studentID";
            ...
            JOptionPane.showMessageDialog(null, "Ошибка при извлечении данных: " + e.getMessage());
        }
    }
